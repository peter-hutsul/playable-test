...
var GLTFLoader = (function () {
  ...
  GLTFMeshStandardSGMaterial.prototype = Object.create(MeshLambertMaterial.prototype);
  ...
  function createDefaultMaterial(cache) {
    if (cache["DefaultMaterial"] === undefined) {
      cache["DefaultMaterial"] = new MeshLambertMaterial({
        color: 0xffffff,
        side: FrontSide
      });
    }
  ...
  GLTFParser.prototype.loadMaterial = function (materialIndex) {
    ...
    if (materialDef.normalTexture !== undefined && materialType !== MeshLambertMaterial) {
    ...
    if (materialDef.occlusionTexture !== undefined && materialType !== MeshLambertMaterial) {
    ...
    if (materialDef.emissiveFactor !== undefined && materialType !== MeshLambertMaterial) {
      materialParams.emissive = new Color().fromArray(materialDef.emissiveFactor);
    }

    if (materialDef.emissiveTexture !== undefined && materialType !== MeshLambertMaterial) {
