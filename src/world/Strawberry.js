...
export class Strawberry extends Object3D {

  static id = "strawberry"

  constructor() {
    super();
    this.form1 = app.cache.gltf.objects.scene.getObjectByName("strawberry_1");
    this.form2 = app.cache.gltf.objects.scene.getObjectByName("strawberry_2");
    this.form3 = app.cache.gltf.objects.scene.getObjectByName("strawberry_3");
